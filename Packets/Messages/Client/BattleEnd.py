...
from Packets.Messages.Server.BattleResultBan import BattleResultBan
from Packets.Messages.Server.Battle2ResultBan import Battle2ResultBan
    ...
    def process(self):
        if self.player.ban == 1:
            if self.player.Rank != 0:
                BattleResultBan(self.client, self.player).send()
            else:
                if self.player.Team == 0:
                    ...
                    Battle2ResultBan(self.client, self.player).send()
                else:
